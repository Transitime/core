...
import org.transitime.core.MatchProcessor;
...
public class SchemaGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		Option hibernatePackagePathOption=new Option("p","hibernatePackagePath",true,"This is the path to the package containing the hibernate annotated java classes");
		
		Option outputDirectoryOption=new Option("o","outputDirectory",true,"This is the directory to output the sql");					
		...
		try
		{
			...
			/* TODO add dialect to command line options */
			
			if(cmd.hasOption("p")&&cmd.hasOption("o"))
			{
				String packageName=cmd.getOptionValue("p");
				String outputDirectory=cmd.getOptionValue("c");
