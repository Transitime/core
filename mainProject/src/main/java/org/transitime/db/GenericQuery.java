...
public class GenericQuery {
	...
	private static final Logger logger = 
			LoggerFactory.getLogger(GenericQuery.class);
	 ...
	 * @throws SQLException
	 */
	public GenericQuery(String dbType, String dbHost,
			String dbName, String dbUserName, String dbPassword) 
					throws SQLException {
		connection = getConnection(dbType, dbHost,
	 ...
	 * @throws SQLException
	 */
	private static Connection getConnection(String dbType, String dbHost,
			String dbName, String dbUserName, String dbPassword)
			throws SQLException {
	...
	/**
	 * Performs the specified generic query. A List of GenericResult
	 * objects is returned. All number columns (integer or float) are
	 * placed in GenericResult.numbers. A string column is assumed to be
	 * a tooltip and is put in GenericResult.text.
	 * 
	 * @param sql
	 * @return
	 * @throws SQLException
