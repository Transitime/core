...
public interface PredictionComponentElementsGenerator {
	...
	PredictionResult getTravelTimeForPath(Indices indices, AvlReport avlReport, VehicleState vehicleState);
	
	PredictionResult getStopTimeForPath(Indices indices,  AvlReport avlReport, VehicleState vehicleState);
