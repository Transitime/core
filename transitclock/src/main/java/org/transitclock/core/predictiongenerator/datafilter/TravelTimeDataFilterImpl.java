...
public class TravelTimeDataFilterImpl implements TravelTimeDataFilter {
	...
	private static LongConfigValue maxTravelTimeAllowedInModel = new LongConfigValue(
			"transitclock.prediction.dwell.maxTravelTimeAllowedInModel", (long) (20 * Time.MS_PER_MIN),
			"Max travel time to be considered in algotithm.");
	private static LongConfigValue minTravelTimeAllowedInModel = new LongConfigValue(
			"transitclock.prediction.dwell.minTravelTimeAllowedInModel", (long) 1000,
			"Min travel time to be considered in algotithm.");
