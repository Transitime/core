...
<div class="panel split overflow-x-hidden">
        ...
        <form class="row" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 pad-left-0">
                    <input  class="form-control"  id="allowableEarly" name="allowableEarly"
            ...
            <div class="row">
                ...
                <div class="col-sm-5 pad-left-0">
                    <input   class="form-control"  id="allowableLate" name="allowableLate"
    ...
    <div class="right-panel  position-relative">
        ...
        <div class="list-group toggle-chart d-none">
            <button class="list-group-item list-group-item-action" >Prediction Accuracy Range Chart</button>
        </div>
        ...
        <div class="row d-flex justify-content-center toggle-chart d-none" id="summaryChartDetails">
...
<script>
    ...
    $( "#submit" ).click(function(e) {
        ...
        request.allowableEarly= $("#allowableEarly").val();


        request.allowableLate = $("#allowableLate").val();
        ...
        $.ajax({
            url:  "/web/reports/predAccuracyRangeData.jsp",
            ...
            success: function (data){
              ...
              $.ajax({
                    ...
                    success: function (data){
                        ...
                        document.getElementById('summaryChartDetails').innerHTML = "<div class='d-flex'>Schedule Adherence over " + results[0] + " arrival and departures</div>"
                            + "<div class='d-flex'>Early: <b>" + results[1]
                            + "</div><div class='d-flex'></b>% OnTime: <b>" + results[2]
                            + "</div><div class='d-flex'></b>% Late: <b>" + results[3] + "</b>%"
                            + "</div>";
                    }
                })
