 ...
 * <p>
 * One creates a ChartJsonBuilder and then adds the columns using addNumberColumn()
 * and addTooltipColumn().
 * <p>
...
public class ChartJsonBuilder {
	...
	/**
	 * Adds a row element with a long value. Since it is a numeric it is
	 * not quoted.
	 * 
	 * @param value The value of the element to be added to the row
	 */
    ...
    /**
     * Add a simple column without a label
     */
    ...
    /**
     * For adding a new row of data. The returned RowBuilder needs to be populated
     * by calling RowBuilder.addRowElement().
     * 
    ...
    /**
     * Once done building a JSON object then this method is used to return 
     * it as a string.
     * 
